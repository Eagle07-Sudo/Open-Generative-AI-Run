...
import { registerAppInterest, getAppInterests } from '../studioGenerate.js';
import toast, { Toaster } from 'react-hot-toast';

const templateApps = [
  {
    name: "AI Headshot Studio",
    description: "Launch a headshot SaaS in minutes. Charge $5Ã¢â‚¬â€œ$20 per set, keep all profits. Stripe payments & user accounts included.",
    icon: FaUserTie,
    color: "blue",
      ...
      <div className="flex flex-col gap-10 items-center w-full max-w-7xl pt-12 pb-24 px-6">
        ...
        <div className="text-center space-y-6 max-w-3xl">
          ...
          <p className="text-white/40 text-sm font-medium leading-relaxed max-w-xl mx-auto">
            ...
            Charge your users, keep the revenue Ã¢â‚¬â€ muapi handles the AI infrastructure.
          </p>
        </div>
        ...
        <div className="w-full grid grid-cols-1 sm:grid-cols-3 gap-4">
          {[
            ...
            },
            {
              ...
              body: "Stripe is pre-wired. Set your own pricing Ã¢â‚¬â€ one-time credits, subscriptions, or pay-per-use."
            },
            {
              icon: FaDollarSign,
              step: "03",
        ...
        <div className="pt-24 pb-12 flex flex-col items-center gap-4">
          <div className="inline-flex items-center gap-3 px-4 py-2 bg-white/5 rounded-full border border-white/5">
            ...
            <span className="text-[9px] font-black text-white/40 uppercase tracking-widest">Muapi Ecosystem Ã¢â‚¬â€ More templates coming soon</span>
          </div>
        </div>
      </div>
